...
prm.f_Hdyn=matlabFunction(subs(Hdyn_exp,[H,L,L1,rho,D],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D]),'vars',{q',M},...
...
Cdyn_exp=subs(Cdyn,[m1,m2,m3,m4],...
    [m1exp,m2exp,m3exp,m4exp]);
prm.f_Cdyn=matlabFunction(subs(Cdyn_exp,[H,L,L1,rho,D],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D]),...
    'vars',{[t1,t2,d3]',[t1dot,t2dot,d3dot]',M},...
...
Gdyn_exp=subs(Gdyn,[m1,m2,m3,m4],...
    [m1exp,m2exp,m3exp,m4exp]);
prm.f_Gdyn=matlabFunction(subs(Gdyn_exp,[H,L,L1,rho,D,g],...
    [prm.H,prm.L,prm.L1,prm.rho,prm.D,prm.g]),'vars',{[t1,t2,d3]',M},...
