...
MODEL                   = RobotSimulation
MODULES                 = rt_logging.c RobotSimulation.c RobotSimulation_capi.c RobotSimulation_data.c RobotSimulation_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = RobotSimulation.exe
MAKEFILE                = RobotSimulation.mk
...
START_DIR               = C:\Users\alons\OneDrive - Technion\Technion\Second Degree\Kinematics, Dynamics and Control of Robots\HW\HW4\SimulationCode\Cash
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 6
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = RobotSimulation_ref.rsp
COMPILER_COMMAND_FILE     = RobotSimulation_comp.rsp
